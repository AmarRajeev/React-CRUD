...
import CustomerDeletePopup from './CustomerDeletePopup'
...
export class Customers extends Component {
    ...
    fetchCustomerDetails() {
        ...
        axios.get('customers/getcustomer') // not case sensitive   
        .then(({ data }) => {
        ...
        if (loading) {
            ...
            return (
                ...
                <div>
                     ...
                     <CustomerDeletePopup open={val} deleteId={editid}  deleteCustomerDetail={this.deleteCustomerDetail} />
                     
                     <CustomerEditPopup  open={openEditCustomerModel} name={nam} address={add} editid={editid} editCustomerDetails={this.editCustomerDetails}  />
                   
                    <CreateCustomerPopup open={createvalue} createCustomerDetails={this.createCustomerDetails}/>
